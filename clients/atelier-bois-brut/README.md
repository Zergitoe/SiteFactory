...
Site web professionnel genere par **Site Factory** le 2026-04-10.

## Informations

- **Client** : Atelier Bois Brut
- **Secteur** : Ébénisterie artisanale, mobilier sur-mesure
- **Style** : nature-artisanal
- **Domaine cible** : atelier-bois-brut.fr
- **Slug** : `atelier-bois-brut`
- **Mot-cle principal** : ébéniste Perche
...
3. **Root Directory** : `clients/atelier-bois-brut`
...
- Settings -> Domains -> ajoute `atelier-bois-brut.fr` et `www.atelier-bois-brut.fr`
