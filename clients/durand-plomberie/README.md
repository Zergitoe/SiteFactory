...
Site web professionnel genere par **Site Factory** le 2026-04-14.

## Informations

- **Client** : Durand Plomberie
- **Secteur** : Plomberie, chauffage et sanitaire
- **Style** : pro-efficace
- **Domaine cible** : durand-plomberie.fr
- **Slug** : `durand-plomberie`
- **Mot-cle principal** : plombier Toulouse
- **Ville** : Toulouse
...
3. **Root Directory** : `clients/durand-plomberie`
...
- Settings -> Domains -> ajoute `durand-plomberie.fr` et `www.durand-plomberie.fr`
